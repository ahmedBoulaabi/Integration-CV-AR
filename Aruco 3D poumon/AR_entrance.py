...
class AR_render:
    ...
    def __init__(self, camera_matrix, dist_coefs, object_paths, model_scale = 0.03):
    ...
    def changeModel(self):
        self.current_model_index = (self.current_model_index + 1) % len(self.object_paths)
        self.loadModel(self.object_paths[self.current_model_index])
    ...
    def draw_objects(self, image, mark_size = 0.05):
        ...
        if model_matrix is not None:     
            ...
            glDepthMask(GL_FALSE)  # Disable depth mask for transparency
...
if __name__ == "__main__":
    ...
    # dist_coeff = np.array([0.49921041, -2.2731793, -0.01392174, 0.01677649, 3.99742617])    
     ...
     model_paths = ['./Models/poumon_final/poumon.obj']
     ar_instance = AR_render(cam_matrix, dist_coeff, model_paths, model_scale=0.03)
     ar_instance.run()